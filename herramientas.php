...
<div class="container mt-5">
        <h1>Herramientas</h1>
        <p>Aquí tienes acceso a diversas herramientas que pueden ayudarte en tus proyectos.</p>
        <ul>
            <li><a href="#">Editor de código</a></li>
            <li><a href="#">Compiladores</a></li>
            <li><a href="#">Entornos de desarrollo integrados (IDE)</a></li>
            <li><a href="#">Control de versiones</a></li>
        </ul>
    </div>
